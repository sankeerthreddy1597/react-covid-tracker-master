...
* Improve the lat and lng centering of the map on country change.
* Add a new chart/table to visualize the data specific to states from each country selected.
